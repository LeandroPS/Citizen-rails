...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { causa_id: @comentario.causa_id, comentario: @comentario.comentario, data: @comentario.data, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { causa_id: @comentario.causa_id, comentario: @comentario.comentario, data: @comentario.data, usuario_id: @comentario.usuario_id } }
