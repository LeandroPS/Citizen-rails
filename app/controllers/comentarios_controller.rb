class ComentariosController < ApplicationController
  ...
  def create
    @comentario = @Comentario.new(comentario_params)
		...
		@comentario.causa_id = @causa.id

    respond_to do |format|
      if @comentario.save
        format.html { redirect_to causa_comentarios_path, notice: 'Comentario was successfully created.' }
  ...
  private
    ...
    def comentario_params
      params.require(:comentario).permit(:causa_id, :user_id, :data, :comentario)
    end
end
